export const projects = [
  {
    ...
    description: 'Optimize your resume for Applicant Tracking Systems (ATS) and get professional feedback instantly.',
  ...
  {
    title: 'Anurag GPT',
    description: 'This online chatbot will provide a more convenient and user-friendly experience for students and other stakeholders',
    image: 'https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=1800&q=80',
    category: 'NLP',
    tools: ['BeautifulSoup', 'Gemini', 'Flask'],
    github: '#',
    demo: '#'
  },
  {
